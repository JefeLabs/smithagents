...
export const PRESET_AGENTS: PresetAgent[] = [
  ...
  preset({
    ...
    reactions: {
      ...
      neutral: ["Okay, tranquilo — I hear both sides, but nobody's told me the order yet."],
      disagree: ["Fair point, but that's two projects wearing one ticket. Pick which one ships."],
      strong_disagree: ["No, mi gente. That scope will eat the quarter and we still won't know if it works."],
    },
    quickAnswers: {
